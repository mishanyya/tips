...
//Изменяет заголовок title только у главной страницы сайта
...
function modify_document_title_for_front_page( $title ) {
  ...
  else if(is_page('Калькуляторы online')){//выводит имя выбранной категории или подкатегории
      return "Онлайн-калькуляторы для различных вычислений";
  }
  else if(is_page('Расчет кредитных платежей')){//выводит имя выбранной категории или подкатегории
      return "Калькулятор для расчета аннуитетного кредита";
  }
  else if(is_page('Расчет факториала')){//выводит имя выбранной категории или подкатегории
      return "Калькулятор факториалов онлайн";
  }
  else if(is_page('Шанс выиграть в лотерею')){//выводит имя выбранной категории или подкатегории
